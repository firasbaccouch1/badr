...
<body  class="{{ App::isLocale('ar') ? 'rtl' : "" }}">
        ...
        <div class="st-top-header-in">
          <ul class="st-top-header-list">            
            ...
            <svg   enable-background="new 0 0 512.021 512.021" viewBox="0 0 512.021 512.021" xmlns="http://www.w3.org/2000/svg"><g><path d="m367.988 512.021c-16.528 0-32.916-2.922-48.941-8.744-70.598-25.646-136.128-67.416-189.508-120.795s-95.15-118.91-120.795-189.508c-8.241-22.688-10.673-46.108-7.226-69.612 3.229-22.016 11.757-43.389 24.663-61.809 12.963-18.501 30.245-33.889 49.977-44.5 21.042-11.315 44.009-17.053 68.265-17.053 7.544 0 14.064 5.271 15.645 12.647l25.114 117.199c1.137 5.307-.494 10.829-4.331 14.667l-42.913 42.912c40.482 80.486 106.17 146.174 186.656 186.656l42.912-42.913c3.837-3.837 9.36-5.466 14.667-4.331l117.199 25.114c7.377 1.581 12.647 8.101 12.647 15.645 0 24.256-5.738 47.224-17.054 68.266-10.611 19.732-25.999 37.014-44.5 49.977-18.419 12.906-39.792 21.434-61.809 24.663-6.899 1.013-13.797 1.518-20.668 1.519zm-236.349-479.321c-31.995 3.532-60.393 20.302-79.251 47.217-21.206 30.265-26.151 67.49-13.567 102.132 49.304 135.726 155.425 241.847 291.151 291.151 34.641 12.584 71.867 7.64 102.132-13.567 26.915-18.858 43.685-47.256 47.217-79.251l-95.341-20.43-44.816 44.816c-4.769 4.769-12.015 6.036-18.117 3.168-95.19-44.72-172.242-121.772-216.962-216.962-2.867-6.103-1.601-13.349 3.168-18.117l44.816-44.816z"/><path d="m496.02 272c-8.836 0-16-7.164-16-16 0-123.514-100.486-224-224-224-8.836 0-16-7.164-16-16s7.164-16 16-16c68.381 0 132.668 26.628 181.02 74.98s74.98 112.639 74.98 181.02c0 8.836-7.163 16-16 16z"/><path d="m432.02 272c-8.836 0-16-7.164-16-16 0-88.224-71.776-160-160-160-8.836 0-16-7.164-16-16s7.164-16 16-16c105.869 0 192 86.131 192 192 0 8.836-7.163 16-16 16z"/><path d="m368.02 272c-8.836 0-16-7.164-16-16 0-52.935-43.065-96-96-96-8.836 0-16-7.164-16-16s7.164-16 16-16c70.58 0 128 57.42 128 128 0 8.836-7.163 16-16 16z"/></g></svg>
              <a href="#">{{ $phoneNumber }}</a></li>
          </ul>
                <a href="#appointment" class="st-top-header-btn st-smooth-move">{{ __('message.appointment') }}     </a>       
        </div>
      </div>
    </div>
        ...
        <div class="container">
          <div class="st-main-header-in">
            <div class="st-main-header-left">
              <a class="st-site-branding" href="{{ route('home') }}"><img  style="width:100px;" src="{{ asset('assets/IMG-20240313-WA0002.jpg') }}" alt="Nischinto"></a>
            </div>
            <div class="st-main-header-right">
              <div class="st-nav">
                <ul class="st-nav-list st-onepage-nav">
                  <li><a href="#home" class="st-smooth-move"> {{ __('message.home') }}</a></li>
                  <li><a href="#about" class="st-smooth-move">{{ __('message.about') }}</a></li>
                  <li><a href="#department" class="st-smooth-move">{{ __('message.department') }}</a></li>
                  <li><a href="#doctors" class="st-smooth-move">{{ __('message.doctors') }}</a></li>
                  <li><a href="#gallery" class="st-smooth-move">{{ __('message.gallery') }}</a></li>
                  <li class="menu-item-has-children"><a class="st-smooth-move">{{ __('message.language') }}</a>
                    <ul>
                    <li><a href="{{ route("changeAr") }}" style="{{ App::isLocale('ar') ?     "color: #0cb8b6;" : "" }}">Arabic</a></li>
                    <li><a href="{{ route('changeEn') }}"style="{{ App::isLocale('en') ?     "color: #0cb8b6;" : "" }}">English</a></li>
                    </ul>
                  </li>

                  <li><a href="#contact" class="st-smooth-move">{{ __('message.contact') }}</a></li>
                </ul>
              </div>
            </div>
          </div>
  ...
  <div class="st-content">
                ...
                <div class="container">
                  <div class="st-hero-text">
                    ...
                    <div class="st-hero-btn-group">
                      <a href="#appointment" class="st-btn st-style1 st-size-medium st-color1 st-smooth-move">{{ __('message.appointment') }}</a>
                      <a href="#about" class="st-btn st-style1 st-size-medium st-color3 st-smooth-move">{{ __('message.about') }}</a>
                    </div>
        ...
        <div class="st-tabs st-fade-tabs st-style1">
          <ul class="st-tab-links st-style1 st-mp0">
            <li class="st-tab-title active ">
              <a href="#hair_transplant" class="st-blue-box">
                <img src="{{ asset('assets/Images/departments/hair transplant/section logo/hair-transplant.png') }}" style="border-radius: 50%;
                width: 76px !important;
                height: 62px !important; " alt="">
                <span>{{ __('message.hair_transplant') }}</span>
              </a>
            </li>
            <li class="st-tab-title ">
              <a href="#dental_aesthetics" class="st-blue-box">
                <img src="{{ asset('assets/Images/departments/Dental Aesthetics/section logo/dentist_1914427.png') }}" style="border-radius: 50%;
                width: 76px !important;
                height: 62px !important; " alt="">
            ...
            <li class="st-tab-title ">
              <a href="#facial_plastic_surgery" class="st-blue-box">
                <img src="{{ asset('assets/Images/departments/Facial plastic surgery/section logo/face_12821755.png') }}" style="border-radius: 50%;
                width: 76px !important;
                height: 62px !important; " alt="">
            ...
            <li class="st-tab-title ">
              <a href="#obesity_surgery" class="st-blue-box">
                <img src="{{ asset('assets/Images/departments/Obesity Surgery/section logo/bariatric-surgery_12024832.png') }}" style="border-radius: 50%;
                width: 76px !important;
                height: 62px !important; " alt="">
            ...
            <li class="st-tab-title ">
              <a href="#plastic_surgeries" class="st-blue-box">
                <img src="{{ asset('assets/Images/departments/Plastic surgeries/section logo/belly_1721019.png') }}" style="border-radius: 50%;
                width: 76px !important;
                height: 62px !important; " alt="">
          ...
          <div class="tab-content">
            <div id="hair_transplant" class="st-tab active">
              <div class="row">
                <!-- .col -->
                <a href="{{ route('blog','beard_and_mustache_transplantation') }}" class="col-lg-4" style="cursor: pointer">
                  <div  class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/hair transplant/Beard and Mustache Transplantation/01_0008_beard-min.jpg') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.beard_and_mustache_transplantation') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->
                <!-- .col -->
                <a  href="{{ route('blog','eyebrow_transplant') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/hair transplant/Eyebrow Transplant/911633055.png') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.eyebrow_transplant') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->
                <!-- .col -->
                <a href="{{ route('blog','hair_transplant_for_men') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/hair transplant/Hair Transplant for men/631547501.jpg') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.hair_transplant_for_men') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->
                <!-- .col -->
                <a href="{{ route('blog','hair_transplantation_for_women') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/hair transplant/Hair transplantation for women/600966099.png') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.hair_transplantation_for_women') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->
            ...
            <div id="dental_aesthetics" class="st-tab ">
              <div class="row">
                <!-- .col -->
                <a href="{{ route('blog','dental_implant') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/Dental Aesthetics/Dental Implant/01_0007_implants-min.jpg') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.dental_implant') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->
                <!-- .col -->
                <a href="{{ route('blog','hollywood_smile') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/Dental Aesthetics/Hollywood smile/212903621.jpg') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.hollywood_smile') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->
            ...
            <div id="facial_plastic_surgery" class="st-tab ">
              <div class="row">
                <!-- .col -->
                <a href="{{ route('blog','botox_injection') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/Facial plastic surgery/Botox Injection/01_0004_botox-min.jpg') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.botox_injection') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->
                <!-- .col -->
                <a  href="{{ route('blog','ear_surgery') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/Facial plastic surgery/Ear Surgery/01_0013_ear-min.jpg') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.ear_surgery') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->
                <!-- .col -->
                <a  href="{{ route('blog','eyelid_lift') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/Facial plastic surgery/Eyelid Lift/01_0003_eyelid-min.jpg') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.eyelid_lift') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->
                <!-- .col -->
                <a href="{{ route('blog','facelift') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/Facial plastic surgery/Facelift/559885878.png') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.facelift') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->      
                <!-- .col -->
                <a href="{{ route('blog','filler_injection') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/Facial plastic surgery/Filler Injection/01_0011_filler-min.jpg') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.filler_injection') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->          
                <!-- .col -->
                <a href="{{ route('blog','lip_augmentation') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/Facial plastic surgery/Lip Augmentation/01_0014_lip_aug-min.jpg') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.lip_augmentation') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->       
                <!-- .col -->
                <a href="{{ route('blog','rhinoplasty') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/Facial plastic surgery/Rhinoplasty/01_0000_rhinoplasty-min.jpg') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.rhinoplasty') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->       
                <!-- .col -->
                <a href="{{ route('blog','texas_jawline_lift') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/Facial plastic surgery/Texas Jawline Lift/1303937626.png') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.texas_jawline_lift') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->       
            ...
            <div id="obesity_surgery" class="st-tab ">
              <div class="row">
                <!-- .col -->
                <a href="{{ route('blog','gastric_balloon') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/Obesity Surgery/gastric balloon/IMG-20240328-WA0023.jpg') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.gastric_balloon') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->
                <!-- .col -->
                <a href="{{ route('blog','gastric_bypass') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/Obesity Surgery/Gastric Bypass/IMG-20240328-WA0031.jpg') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.gastric_bypass') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->
                <!-- .col -->
                <a href="{{ route('blog','gastric_sleeve') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/Obesity Surgery/Gastric Sleeve/IMG-20240328-WA0029.jpg') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.gastric_sleeve') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->
            ...
            <div id="plastic_surgeries" class="st-tab">
              <div class="row">
                <!-- .col -->
                <a href="{{ route('blog','breast_augmentation') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/Plastic surgeries/Breast Augmentation/1937223120.jpg') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.breast_augmentation') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->
                <!-- .col -->
                <a href="{{ route('blog','buttock_augmentation') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/Plastic surgeries/Buttock Augmentation/01_0000_Butt_Aug-min.jpg') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.buttock_augmentation') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->
                <!-- .col -->
                <a href="{{ route('blog','gynecomastia') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/Plastic surgeries/Gynecomastia/01_0015_gynocomastia-min.jpg') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.gynecomastia') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->
                <!-- .col -->
                <a href="{{ route('blog','liposuction') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/Plastic surgeries/Liposuction/01_0004_Lipo-min.jpg') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.liposuction') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->
                <!-- .col -->
                <a href="{{ route('blog','tummy_tuck') }}" class="col-lg-4" style="cursor: pointer">
                  <div class="st-iconbox st-style1">
                    <div class="st-iconbox-icon st-purple-box" style=" background-color: unset;    height: 100%;
                    width: 100%;">
                      <img src="{{ asset('assets/Images/departments/Plastic surgeries/Tummy Tuck/01_0005_tummy-min.jpg') }}" alt="">
                    </div>
                    <h2 class="st-iconbox-title">{{ __('message.tummy_tuck') }}</h2>
                  </div>
                  <div class="st-height-b0 st-height-lg-b30"></div>
                </a>
                <!-- .col -->
    ...
    <div class="st-google-map">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d6024.149837438027!2d28.7443041!3d40.9798403!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14caa19e94ffce07%3A0x42a46121ef9a17c7!2sFlorya%20Hastanesi!5e0!3m2!1sen!2stn!4v1710287424320!5m2!1sen!2stn" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
  </div>
  <!-- Start Footer -->
          ...
          <div class="col-lg-3">
            <div class="st-footer-widget">
              ...
              <ul class="st-footer-contact-list st-mp0">
               <li><span class="st-footer-contact-title">Email:</span> {{ $Email }}</li>
                <li><span class="st-footer-contact-title">Phone:</span> {{ $phoneNumber }}</li>
              </ul>
            </div>
          </div><!-- .col -->
        </div>
